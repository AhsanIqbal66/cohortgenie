...
import { LoginSchema, Varify2FASchema } from "@/schema";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-[54%] mx-auto flex flex-col justify-center px-[4vw] relative">
        <div className="w-full max-w-[385px] mx-auto">
          ...
          <h2 className="text-center text-2xl font-semibold text-primary-text mb-[4.5vh]">Authenticate Your Account</h2>
          ...
          {/* <Formik
            ...
            validationSchema={Varify2FASchema}
          ...
          >
            {({ values }) => (
              <Form className="space-y-[2.6vh]">
                <InputField
                  name="otp"
                  placeholder="Add Your Code Sent To Your Email"
                  type="number"
                />
